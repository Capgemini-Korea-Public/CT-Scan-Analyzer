...
namespace SentenceSimilarityUnity
{
    public class Rake
    {
        ...
        public Rake(HashSet<string> stopWords, int minCharLength = 1, int maxWordsLength = 5, double minKeywordFrequency = 1)
        {
            _minCharLength = minCharLength;
            _maxWordsLength = maxWordsLength;
            _minKeywordFrequency = minKeywordFrequency;
        ...
        private Dictionary<string, double> GenerateCandidateKeywordScores(List<string> phraseList, Dictionary<string, double> wordScores, double minKeywordFrequency)
        {
        ...
        private List<string> GenerateCandidateKeywords(string[] sentenceList, int minCharLength, int maxWordsLength)
        {
            ...
            foreach (string sentence in sentenceList)
            {
                ...
                StringSplitter wordSplitter = new StringSplitter(sLowerCase.AsSpan(), ' ');
